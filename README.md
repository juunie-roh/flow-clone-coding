# flow-clone-coding
반응형 웹 디자인 및 javascript 적용 기본을 목표로 하는 클론 코딩 프로젝트입니다. [*확인하기*](https://github.com/juunie-roh/flow-clone-coding#:~:text=juunie%2Droh.github.io/flow%2Dclone%2Dcoding/, "flow clone coding")   
